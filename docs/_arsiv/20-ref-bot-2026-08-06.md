> ## ⛔ EMEKLİ SÜRÜM — 22 Ağustos 2026'da arşive alındı
>
> Bu dosya **6 Ağustos 2026 tarihli** `docs/20-ref-bot.md`'nin son hâlidir.
> Canlı referans **yerinde durmaya devam ediyor** (`docs/20-ref-bot.md`), gövdesi
> 22 Ağustos'ta baştan yazıldı. Emekliye ayrılma sebebi: bu gövde 13–14 Temmuz
> rebuild'inden **önceki** mimariyi anlatıyor (tek Code node, Notion'dan canlı
> okuma, Postgres yok) ve altı hafta boyunca gerçeği yansıtmadı.
>
> **Bu dosya düzeltilmez** — koşulduğu günün kaydıdır ve o gün doğruydu
> (`05-harita.md:129`).
>
> **Nereye ne gitti:** dört bölüm canlı dosyaya **taşındı**, kırpılmadı
> (KARAR 61) — MailerLite Custom Field envanteri · KARAR 57 veri etik
> çerçevesi · KARAR 410 Meta display name · KARAR 447 WhatsApp stratejik
> konumlama. Eşleme tablosu canlı dosyanın sonundadır
> (`20-ref-bot.md` → *"EK · ESKİ GÖVDEDEN EŞLEME"*). Geri kalan gövde yalnız
> burada yaşar.
>
> **Satır 13'e atıf yapan üç yer** (`02-borclar.md` · `03-sira.md` ·
> `90-kronoloji/2026-08.md`) 22 Ağustos'ta **bu dosyaya** çevrildi; canlı
> dosyanın 13. satırı artık başka bir şey söylüyor.
>
> `_bolme-haritasi.tsv`'ye dokunulmadı — o tablo tek bir PİLOT dosyasının
> satır-satır dağıtım haritasıdır, genel taşıma kütüğü değildir (Kaan kararı,
> 22 Ağu). Köken izi bu şerhtir.
